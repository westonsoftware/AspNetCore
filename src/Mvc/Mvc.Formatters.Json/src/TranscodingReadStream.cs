...
namespace Microsoft.AspNetCore.Mvc.Formatters.Json
{
    internal sealed class TranscodingReadStream : Stream
    {
        ...
        public TranscodingReadStream(Stream input, Encoding sourceEncoding, Encoding targetEncoding)
        {
        ...
        public override async Task<int> ReadAsync(byte[] buffer, int offset, int count, CancellationToken cancellationToken)
        {
            ...
            var maxCharsToRead = count / _targetEncoding.GetMaxByteCount(1);
            ...
            try
            {
                ...
                return _targetEncoding.GetBytes(
